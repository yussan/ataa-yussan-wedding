    ...
    <>
      ...
      >
        <defs>
          ...
          >
            <image
              xlinkHref="https://s3-us-west-2.amazonaws.com/s.cdpn.io/78881/pattern_141.gif"
              width={100}
              height={100}
              preserveAspectRatio="none"
            />
      ...
      <section className="scene3d">
              ...
              <var className="translate3d">
                <var className="translate3d-1">
                  <figure className="butterfly">
                    <svg className="wing left" viewBox="0 0 50 100">
                      <use className="left" xlinkHref="#shape-butterfly-1" />
                    </svg>
                    <svg className="wing right" viewBox="0 0 50 100">
                      <use className="left" xlinkHref="#shape-butterfly-1" />
                    </svg>
                  </figure>
                </var>
                  ...
                  <figure className="butterfly">
                    <svg
                      ...
                      style={{
                        ...
                        msAnimationDuration: ".75s",
                        OAnimationDuration: ".75s",
        ...
        <div
          className="butterfly_container scale_half"
          style={{
            marginTop: "-10px",
            marginLeft: 50,
            WebkitAnimationDuration: "5s",
        ...
        <div
          className="butterfly_container scale_third"
          style={{
            marginTop: 150,
            WebkitAnimationDuration: "20s",
            MozAnimationDuration: "20s",
                ...
                <var className="translate3d-1">
                  <figure className="butterfly">
                    <svg
                      ...
                      viewBox="0 0 50 100"
                      style={{
                        WebkitAnimationDuration: ".35s",
                        MozAnimationDuration: ".35s",
                        msAnimationDuration: ".35s",
                        OAnimationDuration: ".35s",
                ...
                <var className="translate3d-1">
                  <figure className="butterfly">
                    <svg
                      ...
                      viewBox="0 0 50 100"
                      style={{
                        WebkitAnimationDuration: ".45s",
                        MozAnimationDuration: ".45s",
                        msAnimationDuration: ".45s",
                        OAnimationDuration: ".45s",
